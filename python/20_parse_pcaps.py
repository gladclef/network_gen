...
def main():
    ...
    for file in glob.glob("20_*.pcap"):
        ...
        os.system(f"tshark -r {file} -T fields -e frame.time_relative -e ip.src -e ip.dst -e ip.len -E header=y -E separator=, -E quote=d -E occurrence=f > 20_pcap_ppp-{n0}-{n1}.csv")
